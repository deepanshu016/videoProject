                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <form action="{{ route('admin.terms.condition') }}" method="POST" enctype="multipart/form-data" class="upload-video">
                                    @csrf
                                        <div class="live-preview">
                                            <div class="mb-3">
                                               <label for="videoDescription" class="form-label">Terms & Condition Content</label>
                                               <textarea class="form-control" rows="3" placeholder="Terms & Condition Content" name="terms_condition" id="terms_conditionssss"></textarea>
